...
//let private executeDlg dlg owner text caption (onYes: Action) (onNo: Action) =
//    match dlg owner text caption with
//    | MessageBoxResult.No ->
//        match onNo with
//        | null -> ()
//        | no -> no.Invoke()
...
//    =
//    executeDlg AsteriskYesNoMessageBox owner text caption onYes onNo

//let ExecuteYesNoWarning
//    owner
//    text
//    caption
//    (onYes: Action)
//    ([<Optional; DefaultParameterValue(null: Action)>] onNo: Action)
//    =
//    executeDlg WarningYesNoMessageBox owner text caption onYes onNo

//let ExecuteYesNoError
//    owner
//    text
//    caption
//    (onYes: Action)
//    ([<Optional; DefaultParameterValue(null: Action)>] onNo: Action)
//    =
//    executeDlg ErrorYesNoMessageBox owner text caption onYes onNo
